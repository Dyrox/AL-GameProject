...
class PhysicsEntity:
    ...
    def render(self, surf, offset=[0,0]):
        ...
        adjusted_pos = (self.pos[0] - offset[0] + self.anim_offset[0], self.pos[1] - offset[1]+ self.anim_offset[1])
        surf.blit(pygame.transform.flip(self.animation.img(),self.flip,False),adjusted_pos)
    ...
    def update(self, tilemap, movement=(0, 0)):
        ...
        if abs(self.dashing) in {60,50}:
            for i in range(20):
                ...
                self.game.particles.append(Particle(self.game,'particle',self.entity_rect.center,velocity = pvelocity,frame = random.randint(0,7)))
